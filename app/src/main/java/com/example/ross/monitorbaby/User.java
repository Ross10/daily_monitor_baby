...
public class User {
     ...
     */
    public User(String displayName, String email, String connection, long createdAt, String photoUrl,String childName , String phoneNumber, String nannyAddress) {
    ...
    public String getNannyAddress() {return nannyAddress;}
