...
public class chatingActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {

    // Private class members
    private static String TAG = chatingActivity.class.getSimpleName();
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    // User is signed out
//                    Intent intent = new Intent(chatingActivity.this, LoginActivity.class);
...
//                    startActivity(intent);
    ...
    private void startBackgroundService() {
        ...
        if(!isServiceRunning()) {
            Intent serviceIntent = new Intent(chatingActivity.this, FirebaseBackgroundService.class);
